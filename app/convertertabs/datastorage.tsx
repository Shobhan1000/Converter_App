...
const datastoreUnits = ['Bit', 'Byte', 'Kilobyte', 'Megabyte', 'Gigabyte', 'Terabyte', 'Petabyte', 'Exabyte', 'Zettabyte', 'Yottabyte', 'Nibble'];
...
const DataStore: React.FC = () => {
  ...
  const [result, setResult] = useState('');
    ...
    switch (from) {
        ...
        case 'Nibble': bits = val * 4; break;
        case 'Byte': bits = val * 8; break;
        case 'Kilobyte': bits = val * 8 * 1024; break;
        case 'Megabyte': bits = val * 8 * 1024 ** 2; break;
        case 'Gigabyte': bits = val * 8 * 1024 ** 3; break;
        case 'Terabyte': bits = val * 8 * 1024 ** 4; break;
        case 'Petabyte': bits = val * 8 * 1024 ** 5; break;
        case 'Exabyte': bits = val * 8 * 1024 ** 6; break;
        case 'Zettabyte': bits = val * 8 * 1024 ** 7; break;
        case 'Yottabyte': bits = val * 8 * 1024 ** 8; break;
        default: bits = val;
    }
    ...
    switch (to) {
        case 'Bit': converted = bits; break;
        case 'Nibble': converted = bits / 4; break;
        case 'Byte': converted = bits / 8; break;
        case 'Kilobyte': converted = bits / (8 * 1024); break;
        case 'Megabyte': converted = bits / (8 * 1024 ** 2); break;
        case 'Gigabyte': converted = bits / (8 * 1024 ** 3); break;
        case 'Terabyte': converted = bits / (8 * 1024 ** 4); break;
        case 'Petabyte': converted = bits / (8 * 1024 ** 5); break;
        case 'Exabyte': converted = bits / (8 * 1024 ** 6); break;
        case 'Zettabyte': converted = bits / (8 * 1024 ** 7); break;
        case 'Yottabyte': converted = bits / (8 * 1024 ** 8); break;
        default: converted = bits;
    }
