...
const temperatureUnits = ['Celsius', 'Fahrenheit', 'Kelvin', 'Rankine', 'Réaumur'];
...
const Temperature: React.FC = () => {
  ...
  const [result, setResult] = useState('');
    ...
    switch (from) {
        ...
        case 'Réaumur': celsius = val * 1.25; break;
        default: celsius = val;
    }
    ...
    switch (to) {
        ...
        case 'Rankine': converted = (celsius + 273.15) * 9/5; break;
        case 'Réaumur': converted = celsius * 0.8; break;
