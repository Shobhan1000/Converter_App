...
const weightUnits = ['Grams', 'Kilograms', 'Pounds', 'Ounces', 'Stones', 'Milligrams', 'Micrograms', 'Tonnes'];
...
const Weight: React.FC = () => {
  ...
  const convert = (value: string, from: string, to: string) => {
    ...
    case 'Stones': grams = val * 6350.29; break;
    case 'Milligrams': grams = val / 1000; break;
    case 'Micrograms': grams = val / 1e6; break;
    ...
    case 'Stones': converted = grams / 6350.29; break;
    case 'Milligrams': converted = grams * 1000; break;
    case 'Micrograms': converted = grams * 1e6; break;
